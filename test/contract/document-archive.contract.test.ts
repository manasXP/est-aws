...
describe('STR-114 T-C1 — document archive/restore endpoint contract', () => {
  it('POST .../archive conforms to the declared 200 Document response shape', async () => {
    ...
    const response = await dispatchRequest('POST', `/v1/documents/${documentId}/archive`);
  ...
  it('POST .../restore conforms to the declared 200 Document response shape', async () => {
    ...
    const response = await dispatchRequest('POST', `/v1/documents/${documentId}/restore`);
  ...
  it('POST .../archive and .../restore on a nonexistent document conform to the declared 404 shape', async () => {
    ...
    const archive404 = await dispatchRequest('POST', '/v1/documents/no-such-document/archive');
    ...
    const restore404 = await dispatchRequest('POST', '/v1/documents/no-such-document/restore');
