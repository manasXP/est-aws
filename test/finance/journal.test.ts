...
describe('STR-021 posting writer — append-only double-entry journal', () => {
  ...
  it('applies the finance migrations idempotently', async () => {
    ...
    expect(first.applied).toEqual([
      ...
      '035_document_metadata_audits.sql',
      '036_offline_payments.sql',
      '037_tally_export_jobs.sql',
      '038_documents_search.sql',
      '039_tickets.sql',
      '040_ticket_actions.sql',
      '041_ticket_comments.sql',
      '042_ticket_attachments.sql',
      '043_bulletin_posts.sql',
      '044_ticket_work_order.sql',
      '045_admin_cognito_subjects.sql',
    ]);
